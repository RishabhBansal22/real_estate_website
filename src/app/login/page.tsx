...
import { Home, KeyRound, Mail, AlertCircle, ArrowRight, Sparkles } from "lucide-react";
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0f1d] flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-primary-blue rounded-full blur-[120px] opacity-60 -translate-y-1/2 translate-x-1/3 pointer-events-none"></div>
        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-sm font-bold uppercase tracking-widest text-slate-400">
              Or{" "}
              <Link href="/register" className="text-accent-gold hover:text-white transition-colors">
                request access to our portfolio
              </Link>
            </p>
          </div>
        </div>
              ...
              <div>
                <div className="flex items-center justify-between mb-3 ml-1">
                   ...
                   <div className="text-[10px]">
                     <a href="#" className="font-black text-accent-gold hover:text-white transition-colors tracking-widest uppercase">
                       Lost Key?
                     </a>
                   </div>
                </div>
